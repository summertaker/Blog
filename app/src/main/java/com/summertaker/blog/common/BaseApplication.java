            ...
            try {
                ...
                if (isValid) {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        m.setUpdated(obj.getBoolean("isUpdated"));
                ...
                e.printStackTrace();
                Log.e(mTag, "ERROR:loadMember().JSONException: " + e.getMessage());
            }
        }
    ...
    public void saveMember(String key, ArrayList<Member> members) {
        ...
        try {
            ...
            for (Member m : members) {
                ...
                o.put("isUpdated", m.isUpdated());
                o.put("lastDate", m.getLastDate());
                array.put(o);

                //Log.e(mTag, m.getName() + " / " + m.isUpdated() + " saved...");
            }
            ...
            e.printStackTrace();
            Log.e(mTag, "ERROR:saveMember().JSONException: " + e.getMessage());
        }
    }
